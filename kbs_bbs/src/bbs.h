...
#define WBBS_SHENXIAO_COW	2
#define WBBS_SHENXIAO_TIGER	3
#define WBBS_SHENXIAO_RABBIT	4
#define WBBS_SHENXIAO_DRAGON	5
#define WBBS_SHENXIAO_SNAKE	6
#define WBBS_SHENXIAO_HORSE	7
#define WBBS_SHENXIAO_SHEEP	8
#define WBBS_SHENXIAO_MONKEY	9
#define WBBS_SHENXIAO_COCK	10
#define WBBS_SHENXIAO_DOG	11
#define WBBS_SHENXIAO_PIG	12

#define WBBS_BLOODTYPE_UNKNOWN	0
#define WBBS_BLOODTYPE_A	1
#define WBBS_BLOODTYPE_B	2
#define WBBS_BLOODTYPE_O	3
#define WBBS_BLOODTYPE_AB	4
#define WBBS_BLOODTYPE_OTHER	5

#define WBBS_RELIGION_UNKNOWN	0
#define WBBS_RELIGION_BUDDHISM	1
#define WBBS_RELIGION_TAOISM	2
#define WBBS_RELIGION_CHRISTIANISM	3
#define WBBS_RELIGION_CATHOLICISM	4
#define WBBS_RELIGION_ISLAMISM	5
#define WBBS_RELIGION_OTHER	6

#define WBBS_PROFESSION_UNKNOWN 0
#define WBBS_PROFESSION_FINANCE 1
#define WBBS_PROFESSION_ENGINEER	2
#define WBBS_PROFESSION_COUNSELOR	3
#define WBBS_PROFESSION_IT	4
#define WBBS_PROFESSION_HOUSEWIFE	5
#define WBBS_PROFESSION_EDUCATION	6
#define WBBS_PROFESSION_SUPPORT		7
#define WBBS_PROFESSION_SELLER		9
#define WBBS_PROFESSION_RETIRED		10
#define WBBS_PROFESSION_NOJOB		11
#define WBBS_PROFESSION_STUDENT		12
#define WBBS_PROFESSION_MARKET		13
#define WBBS_PROFESSION_RESEARCH	14
#define WBBS_PROFESSION_MANAGE		15
#define WBBS_PROFESSION_GOVERMENT	16
#define WBBS_PROFESSION_EXECUTE		17
#define WBBS_PROFESSION_PRODUCE		18
#define WBBS_PROFESSION_PROFESSION	19
#define WBBS_PROFESSION_SELF		20
#define WBBS_PROFESSION_OTHER		21

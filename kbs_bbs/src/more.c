...
printacbar()
{
    ...
    move(3+MAXnettyLN,0);
    prints("[35m©¸¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª©È[36m  ¸«  Í·  °ï  [35m©À¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª©¼ [m\n");
    move (y,x);
    refresh();
}
                ...
                else if ('X' == ch) /* Leeward 98.06.05 */
                {
                            ...
                            &&  !strcmp(buffer, filename))
                    {
                        ...
                        if (askyn(buffer, 0))
                        {
                            ...
                            if (fp)
                            {
 	                        fprintf(fp, "¼ÄÐÅÈË: BBS´ó»°Î÷ÓÎÕ¾Õ¾Îñ¹ÜÀíÏµÍ³\n");
                                fprintf(fp, "±ê  Ìâ: ÄúµÄ¸öÈË×ÊÁÏ²»¹»ÏêÊµ£¬Çëµ½¸öÈË¹¤¾ßÏäÄÚ²¹³äÉè¶¨\n");
                                fprintf(fp, "·¢ÐÅÕ¾: BBS ´ó»°Î÷ÓÎÕ¾ (%24.24s)\n",ctime(&now)) ;

...
#define MAXUSERS  20000 /* Maximum number of users,780 aliament 1k*/
#define MAXBOARD  256  /* Leeward: 256->400 due to new system:) */  
                       /* Maximum number of boards */
/*#define MAXACTIVE 666   Leeward: 350->666 due to new system:) */  
#define MAXACTIVE 666

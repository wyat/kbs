  ...
  char *argv[];
{
  ...
  if ((fp = fopen("/home/system/bbs/usies", "r")) == NULL)
  {
  ...
  if ((fp = fopen("/home/system/bbs/0Announce/bbslists/countlogins", "w")) == NULL)
  {
  ...
  fprintf(fp, "   [36m"
    " ©¸¡ª¡ª¡ª[37m   ´ó»°Î÷ÓÎ¸«Í·°ï °Ý·ÃÈËÊý±í    [36m¡ª¡ª¡ª[37m%s[36m¡ª¡ª©¼\n"
